...
(function (root, factory) {
  ...
  function _enable() {
    ...
    for (var i = textAreaList.length - 1; i >= 0; i--) {
      ...
      currentTextArea.setAttribute("datawidearea-id", this._wideAreaId);
    ...
    this._timer = setInterval(function() {
      for (var i = self._textareas.length - 1; i >= 0; i--) {
        ...
        var wideAreaIcons = document.getElementById("widearea-" + currentTextArea.getAttribute("datawidearea-id"));
  ...
  function _enableFullScreen(link) {
    ...
    var targetTextarea = document.querySelector("textarea[datawidearea-id='" + wideAreaId + "']");
